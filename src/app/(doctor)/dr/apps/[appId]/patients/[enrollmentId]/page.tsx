...
import PatientDetailClient from '@/app/(app)/apps/[appId]/patients/[enrollmentId]/PatientDetailClient';
    ...
    return (
      <div className="page-body">
        <div className="container-xl">
          ...
          <Link href={`/dr/apps/${appId}/patients`} className="btn btn-primary">Geri Dön</Link>
        </div>
      </div>
    );
  }
          ...
          <div className="row g-3 align-items-center">
            ...
            <div className="col-auto ms-auto d-print-none">
              <div className="btn-list">
                <Link href={`/dr/apps/${appId}/patients`} className="btn btn-outline-secondary d-flex align-items-center gap-2 shadow-sm">
